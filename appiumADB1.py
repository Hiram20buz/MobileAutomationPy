...
# Iterate through the color_coordinates dictionary and tap on each color's coordinates
for color, (x, y) in color_coordinates.items():
    print(f'Tapping on {color} at coordinates ({x}, {y})')
